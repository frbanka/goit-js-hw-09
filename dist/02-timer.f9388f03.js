...
pageBody.setAttribute("style", "display:flex;flex-direction:column;justify-content:center;align-items:center;row-gap:10px");
goBackBtn.setAttribute("style", "position:absolute;padding-right:90%;top:1%");
timerParent.forEach((e)=>e.setAttribute("style", "display:flex;flex-direction:row;justify-content:center;align-items:center;gap:20px"));
timerEl.forEach((e)=>e.setAttribute("style", "display:flex;flex-direction:column;justify-content:center;align-items:center;font-size:24px"));
